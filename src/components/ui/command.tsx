...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn("absolute top-full left-0 right-0 z-10 bg-white border border-t-0 rounded-b-md shadow-lg max-h-72 overflow-y-auto overflow-x-hidden dark:bg-slate-950", className)}
    {...props}
  />
))
