...
export function ModuleNodeComponent(props: ModuleNodeComponentProps) {
  ...
  return (
    ...
    >
      ...
      {data.isSelected && (
        <div className='absolute -right-2 -top-2 flex items-center gap-1 rounded-full bg-[hsl(var(--primary))] px-2 py-0.5 text-xs font-semibold text-[hsl(var(--primary-foreground))] shadow-sm'>
      ...
      <div className='mb-3 flex items-center gap-3'>
        ...
        <div className='min-w-0 flex-1'>
          <div className='truncate font-mono text-sm font-semibold text-[hsl(var(--foreground))]'>
      ...
      {showCompactRelationCard ? (
        <div className='rounded-lg border border-[hsl(var(--border))] bg-[hsl(var(--muted))]/50 px-3 py-2'>
          <div className='flex items-center justify-between gap-2'>
            <span className='text-xs font-semibold uppercase tracking-label text-[hsl(var(--primary))]'>
              {relationLabel}
            </span>
